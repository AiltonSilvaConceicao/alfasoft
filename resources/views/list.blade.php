                                    ...
                                    @if($dados)
                                        ...
                                        @foreach($dados as $dado)
                                            ...
                                            <tr style="{{ $collor ?? ''}}">
                                                ...
                                                <td> {{ $dado->contact ?? ''}}</td>
                                                <td> {{ $dado->email ?? ''}}</td>
                                                <td> <a href="{{ route('contacts.edit', ['id' => $dado->id]) }}" class="btn btn-primary btn-sm">Edit</a>  <a href="{{ route('contacts.delete', ['id' => $dado->id])}}" class="btn btn-danger btn-sm">Delet</a></td>
                                            </tr>
                                            @php
                                            $i++;
                                            $t++;
